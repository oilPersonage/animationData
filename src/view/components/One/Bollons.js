...
export default class Bollons extends React.Component {
  ...
  render() {
    ...
    const state = Data(this.props.width, this.props.height, this.props.fontSize, this.props.rotation, this.props.well, this.props.circ)
    if (state) {
      return <Layer>
